...
To enhance transparency and reproducibility, this repository includes an `renv` environment that records the exact versions of all R packages used in the analyses. To recreate the computational environment, run:
...
Shiny calculator: https://diananovacostshrqol.shinyapps.io/costs_cp/
